      ...
      return (
        n(a, [
          ...
          },
          {
            ...
            value: function () {
              ...
              if (
                ...
                let d = new p(function (b) {
                  for (let c = 0; c < b.length; c++)
                    for (let d = b[c], e = 0; e < d.addedNodes.length; e++) {
                      let f = d.addedNodes[e];
                      a.doSync(f);
                    }
                });
          ...
          },
          {
            ...
            value: function (a, b) {
              for (
                let c = q(a), d = c.getPropertyCSSValue(b), e = 0;
          ...
          },
          {
            key: 'isVisible',
            value: function (a) {
              let b = a.getAttribute('data-wow-offset') || this.config.offset,
                c =
